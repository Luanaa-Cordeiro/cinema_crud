...
@endif
      ...
      <form action="{{route ('promocoes.update', ['promocao' => $promocao->id])}}" method="POST">
        ...
        <div class="mb-4">
          ...
          <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{$promocao->disponiveis}}" name="disponiveis"/>

          <label for="valor_atual" class="block text-gray-800 font-medium">Valor Atual</label>
          <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{$promocao->valor_atual}}" name="valor_atual"/>

          <label for="valor_promocao" class="block text-gray-800 font-medium">Valor Promocional</label>
